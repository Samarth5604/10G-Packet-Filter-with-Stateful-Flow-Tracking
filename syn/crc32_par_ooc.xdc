# Timing constraints for crc32_par_ooc: the registered-input variant used to
# measure logic depth. Same clock; the I/O budget matters far less here
# because the critical path is now register to register.
#
