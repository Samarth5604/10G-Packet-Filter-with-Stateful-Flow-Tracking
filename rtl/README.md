...
Generated and hand-written Verilog.

`header_parser.v` is GENERATED by `make rtl` from `lib/protocol_spec.ml`, and is
committed so that synthesis and any clone work without an opam switch. Do not
edit it; edit the spec and regenerate.
